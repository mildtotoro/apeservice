...
class TFM extends React.Component {
    render() {
        ...
        ติดตั้งท่อส่งน้ำดับเพลิงไลน์เมนต์ขนาด 6” และ 4” จากปั้มดับเพลิงไปยังตำแหน่ง หัวจ่ายน้ำดับเพลิง Roof Manifold 4”x2-1/2”x2-1/2” จำนวน 7 จุด ทำการทดสอบและใช้งานได้เรียบร้อยตามวัตถุประสงค์ของโครงการ
