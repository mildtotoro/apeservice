  ...
  return (
    <Layout>
      <div className="container">
        <div className="row">
          <div className="col">
            <h2 className="pt-5">รายละเอียดการล้างเครื่องปรับอากาศรายปี</h2>
            <div>
              <div>
                ...
                <h4 className="pt-3">ล้างใหญ่ คอลย์เย็น (Fan coil)</h4>
                <ol>
                ...
                <h4 className="pt-3"> ล้างใหญ่ คอลย์ร้อน (Condensing)</h4>
                <ol>
                ...
                <h4 className="pt-3"> ล้างย่อย คอลย์เย็น (Fan coil)</h4>
                <ol>
                  <li>ล้างทำความสะอาดแผ่นกรองอากาศ  (Filter)</li>
                ...
                <h4 className="pt-3"> ล้างย่อย คอลย์ร้อน  (Condensing)</h4>
                <ol>
