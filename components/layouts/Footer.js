          ...
          <div className="row">
            <div className="col-12 col-md-6 col-lg-4">
              ...
              <p className="d-none d-md-block">
                ...
                แอร์เชิงพาณิชย์(สอบถามได้ที่เบอร์ 02-749-1230-2 หรือ
                081-889-6696 ) ทุกยี่ห้อ ทุกรุ่น
                  <br />
                ราคาปลีก-ส่ง
              </p>
              <p className="d-block d-md-none">
                บริษัท เอ พี อี เซอร์วิส จำกัด
                  <br />
                รับบริการล้างแอร์ ซ่อม ย้าย และติดตั้งแอร์ใหม่<br /> แอร์บ้านราคาถูก
                  คุณภาพดี <br />
                จำหน่ายเครื่องปรับอากาศ แอร์บ้าน
                แอร์เชิงพาณิชย์ <br />(สอบถามได้ที่เบอร์ 02-749-1230-2<br /> หรือ
                081-889-6696 ) ทุกยี่ห้อ ทุกรุ่น
                  <br />
                ราคาปลีก-ส่ง
              </p>
              <p>
                พื้นที่ให้บริการ กรุงเทพฯ ปริมณฑล และจังหวัดกาญจนบุรี
                ให้บริการและติดตั้งโดยผู้ชำนาญการ ประสบการณ์มากกว่า 23 ปี
