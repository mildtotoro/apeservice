  ...
  constructor(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])(this, "gellery", () => {
      ...
      for (let i = 1; i <= imgLength; i++) {
        const imgPath = assetPrefix + "/static/assets/showcase/".concat(projectFolderName, "/") + i + '.jpg'; // gallery.push(<div key={"showcase" + projectFolderName} className="col-12 col-md-6 col-lg-4"><img className="img-fluid" key={imgPath} src={imgPath} alt='' /></div>);

        gallery = react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
...
//# sourceMappingURL=thai-nissei.js.f1a7026a9485e594b976.hot-update.js.map